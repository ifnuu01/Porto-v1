...
export default function Home() {
  return (
    <div className='bg-[url("./assets/img/home.svg")] bg-cover h-screen'>
      <img
        src={MonthSVG}
        alt="Month SVG"
      ...
      <div className="flex flex-col justify-center items-center h-full w-full">
        <h3 className="text-white text-2xl font-roboto font-semibold mb-2">
          Ifnu Umar
        </h3>
        ...
        <div className="flex mt-4 gap-x-4">
          <a className="bg-[#141414] px-10 py-2 rounded-lg cursor-pointer  hover:bg-[#1f1f1f] transition duration-30">
            <svg
